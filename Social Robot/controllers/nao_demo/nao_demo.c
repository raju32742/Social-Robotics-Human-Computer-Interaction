...
// motion file handles
static WbMotionRef happy_wave, hand_wave, forwards, backwards, side_step_left, side_step_right, turn_left_60, turn_right_60, tai_chi,
  wipe_forehead;
...
static void load_motion_files() {
  happy_wave = wbu_motion_new("../../motions/Happy.motion");
